...
agent_communication:
  ...
  - agent: "main"
    message: |
      ...
      BACKEND URL: https://financialchallenge.preview.emergentagent.com
  ...
  - agent: "testing"
    message: |
      ...
      BACKEND URL TESTED: https://financialchallenge.preview.emergentagent.com
  ...
  - agent: "main"
    message: |
      ...
      FRONTEND URL: https://financialchallenge.preview.emergentagent.com
  ...
  - agent: "testing"
    message: |
      ...
      FRONTEND URL TESTED: https://financialchallenge.preview.emergentagent.com
